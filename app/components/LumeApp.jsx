    ...
    <>
      {hasResults?(
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:isMobile?"70vh":"75vh",padding:isMobile?"20px 10px":"32px 24px",width:"100%",minWidth:0,boxSizing:"border-box"}}>
          ...
          {!user&&<div style={{marginTop:isMobile?24:32,width:"100%",maxWidth:380,marginLeft:"auto",marginRight:"auto",padding:isMobile?"0 8px":0}}><div style={{display:"flex",flexDirection:isMobile?"column":"row",alignItems:"center",gap:isMobile?14:20,padding:isMobile?"16px 18px":"20px 24px",background:"transparent",borderRadius:16,border:"1px solid "+BD+"50",boxSizing:"border-box",textAlign:isMobile?"center":"left"}}><div style={{flexShrink:0,width:isMobile?44:52,height:isMobile?44:52,borderRadius:14,background:AC+"12",display:"flex",alignItems:"center",justifyContent:"center",border:"1px solid "+AC+"28"}}><svg width={isMobile?24:28} height={isMobile?24:28} viewBox="0 0 32 32" fill="none"><rect x="6" y="14" width="20" height="12" rx="1.5" stroke={AC} strokeWidth="1.5" fill="none" opacity="0.9"/><path d="M16 14v12M6 20h20" stroke={AC} strokeWidth="1.5" opacity="0.8"/><path d="M16 14c0-2.5 1.8-5 4.5-5 1.5 0 3 .8 3 3s-1.5 3-3 3H16" stroke={AC} strokeWidth="1.4" strokeLinecap="round" fill="none" opacity="0.85"/><path d="M16 14c0-2.5-1.8-5-4.5-5-1.5 0-3 .8-3 3s1.5 3 3 3H16" stroke={AC} strokeWidth="1.4" strokeLinecap="round" fill="none" opacity="0.85"/><circle cx="16" cy="10" r="1.5" fill={AC} opacity="0.6"/></svg></div><div style={{flex:1,minWidth:0}}><div className="lume-gradient-shimmer" style={{fontSize:isMobile?13:14,fontWeight:600,letterSpacing:"-0.01em"}}>1 free research when you sign up</div><div style={{fontSize:isMobile?11:12,color:MU,lineHeight:1.45,marginTop:4}}>Create an account or try the examples above.</div></div></div></div>}
